...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: AzureConfiguration
    #
    ...
    #
    #
    class AzureConfiguration < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPISchemas::AzureServerConfiguration]
        server: {
