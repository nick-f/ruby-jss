...
module Jamf
  ...
  module OAPISchemas
    ...
    #
    #
    class DeviceEnrollmentInstance < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute [r] tokenExpirationDate
        #   @return [String]
        tokenExpirationDate: {
          class: :string,
          readonly: true
    ...
    end # class DeviceEnrollmentInstance
