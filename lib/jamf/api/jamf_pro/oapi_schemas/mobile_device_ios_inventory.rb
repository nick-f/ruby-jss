...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: MobileDeviceIosInventory
    #
    #
    #
    ...
    #
    #
    class MobileDeviceIosInventory < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute general
        #   @return [Jamf::OAPISchemas::MobileDeviceIosGeneral]
        general: {
          class: Jamf::OAPISchemas::MobileDeviceIosGeneral
        },

        # @!attribute security
        #   @return [Jamf::OAPISchemas::MobileDeviceSecurity]
        security: {
          class: Jamf::OAPISchemas::MobileDeviceSecurity
        },

        # @!attribute ebooks
        #   @return [Array<Jamf::OAPISchemas::MobileDeviceEbookInventoryDetail>]
        ebooks: {
          class: Jamf::OAPISchemas::MobileDeviceEbookInventoryDetail,
          multi: true
        },

        # @!attribute network
        #   @return [Jamf::OAPISchemas::MobileDeviceNetwork]
        network: {
        ...
        # @!attribute sharedUsers
        #   @return [Array<Jamf::OAPISchemas::MobileDeviceSharedUser>]
        sharedUsers: {
          class: Jamf::OAPISchemas::MobileDeviceSharedUser,
          multi: true
        },
      ...
      }.merge(Jamf::OAPISchemas::MobileDeviceInventory::OAPI_PROPERTIES) # end OAPI_PROPERTIES

    end # class MobileDeviceIosInventory
