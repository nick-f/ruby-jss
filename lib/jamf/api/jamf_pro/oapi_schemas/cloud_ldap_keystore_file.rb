...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: CloudLdapKeystoreFile
    #
    ...
    #  - '/v1/ldap-keystore/verify:POST' needs permissions:
    #    - Create LDAP Servers
    #
    #
    class CloudLdapKeystoreFile < Jamf::OAPIObject
    ...
    end # class CloudLdapKeystoreFile
