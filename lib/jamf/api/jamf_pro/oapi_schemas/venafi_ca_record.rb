...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: VenafiCaRecord
    #
    #
    #
    ...
    #
    #
    class VenafiCaRecord < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute [r] passwordConfigured
        #   @return [Boolean]
        passwordConfigured: {
          class: :boolean,
          readonly: true
        ...
        # @!attribute [r] refreshTokenConfigured
        #   @return [Boolean]
