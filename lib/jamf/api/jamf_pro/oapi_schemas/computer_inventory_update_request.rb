...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ComputerInventoryUpdateRequest
    #
    #
    #
    ...
    #
    #
    class ComputerInventoryUpdateRequest < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute general
        #   @return [Jamf::OAPISchemas::ComputerGeneralUpdate]
        general: {
          class: Jamf::OAPISchemas::ComputerGeneralUpdate
        },
        ...
        # @!attribute hardware
        #   @return [Jamf::OAPISchemas::ComputerHardwareUpdate]
        hardware: {
          class: Jamf::OAPISchemas::ComputerHardwareUpdate
        },

        # @!attribute operatingSystem
        #   @return [Jamf::OAPISchemas::ComputerOperatingSystemUpdate]
        operatingSystem: {
          class: Jamf::OAPISchemas::ComputerOperatingSystemUpdate
        },
    ...
    end # class ComputerInventoryUpdateRequest
