...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: SsoSettingsV2
    #
    #
    #
    ...
    #  - '/v2/sso:GET' needs permissions:
    #    - Read SSO Settings
    #  - '/v2/sso:PUT' needs permissions:
    #    - Update SSO Settings
    #
    #
    class SsoSettingsV2 < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute enrollmentSsoForAccountDrivenEnrollmentEnabled
        #   @return [Boolean]
