...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ComputerPrestageV2
    #
    #
    #
    ...
    #
    #
    class ComputerPrestageV2 < Jamf::OAPIObject

      # Enums used by this class or others

      RECOVERY_LOCK_PASSWORD_TYPE_OPTIONS = [
        'MANUAL',
        'RANDOM'
      ]
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute installProfilesDuringSetup
        #   @return [Boolean]
        ...
        # @!attribute enableRecoveryLock
        #   @return [Boolean]
        enableRecoveryLock: {
          class: :boolean
        },

        # @!attribute recoveryLockPasswordType
        #   @return [String]
        recoveryLockPasswordType: {
          class: :string,
          enum: RECOVERY_LOCK_PASSWORD_TYPE_OPTIONS
        },

        # @!attribute rotateRecoveryLockPassword
        #   @return [Boolean]
