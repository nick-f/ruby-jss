...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: LapsPendingRotation
    #
    #
    #
    ...
    #
    #
    class LapsPendingRotation < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute lapsUser
        #   @return [Jamf::OAPISchemas::LapsUserV2]
        lapsUser: {
