...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: VolumePurchasingLocationPatch
    #
    #
    #
    ...
    #
    #
    class VolumePurchasingLocationPatch < Jamf::OAPIObject
    ...
    end # class VolumePurchasingLocationPatch
