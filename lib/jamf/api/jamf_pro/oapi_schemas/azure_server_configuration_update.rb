...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: AzureServerConfigurationUpdate
    #
    ...
    #
    #
    class AzureServerConfigurationUpdate < Jamf::OAPIObject
    ...
    end # class AzureServerConfigurationUpdate
