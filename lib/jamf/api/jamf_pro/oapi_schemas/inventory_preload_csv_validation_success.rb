...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: InventoryPreloadCsvValidationSuccess
    #
    #
    #
    ...
    #
    #
    class InventoryPreloadCsvValidationSuccess < Jamf::OAPIObject
    ...
    end # class InventoryPreloadCsvValidationSuccess
