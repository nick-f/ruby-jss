...
module Jamf
  ...
  module OAPISchemas
    ...
    #
    #
    class JamfApplicationResponse < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute artifacts
        #   @return [Array<Jamf::OAPISchemas::JamfPackageResponse>]
        artifacts: {
          class: Jamf::OAPISchemas::JamfPackageResponse,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # class JamfApplicationResponse
