...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ComplianceVendorDeviceInformation
    #
    ...
    #
    #
    class ComplianceVendorDeviceInformation < Jamf::OAPIObject
    ...
    end # class ComplianceVendorDeviceInformation
