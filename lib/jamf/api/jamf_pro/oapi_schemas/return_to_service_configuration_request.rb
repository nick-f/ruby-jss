...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ReturnToServiceConfigurationRequest
    #
    #
    #
    ...
    #
    #
    class ReturnToServiceConfigurationRequest < Jamf::OAPIObject
    ...
    end # class ReturnToServiceConfigurationRequest
