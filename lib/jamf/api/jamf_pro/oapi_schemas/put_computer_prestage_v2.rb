...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: PutComputerPrestageV2
    #
    #
    #
    ...
    #  - '/v2/computer-prestages/{id}:PUT' needs permissions:
    #    - Update Computer PreStage Enrollments
    #
    #
    class PutComputerPrestageV2 < Jamf::OAPIObject
    ...
    end # class PutComputerPrestageV2
