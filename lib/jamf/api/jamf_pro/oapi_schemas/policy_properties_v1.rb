...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: PolicyPropertiesV1
    #
    #
    #
    ...
    #
    #
    class PolicyPropertiesV1 < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute policiesRequireNetworkStateChange
        #   @return [Boolean]
        policiesRequireNetworkStateChange: {
          class: :boolean
        },

        # @!attribute allowNetworkStateChangeTriggers
        #   @return [Boolean]
