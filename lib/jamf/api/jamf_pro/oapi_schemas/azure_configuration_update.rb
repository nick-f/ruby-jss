...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: AzureConfigurationUpdate
    #
    ...
    #  - Jamf::OAPISchemas::AzureServerConfigurationUpdate
    #
    ...
    #
    #
    class AzureConfigurationUpdate < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPISchemas::AzureServerConfigurationUpdate]
        server: {
          class: Jamf::OAPISchemas::AzureServerConfigurationUpdate,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # class AzureConfigurationUpdate
