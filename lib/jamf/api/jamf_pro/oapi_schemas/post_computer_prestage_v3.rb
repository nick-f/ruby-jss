...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: PostComputerPrestageV3
    #
    #
    #
    ...
    #
    #
    class PostComputerPrestageV3 < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Jamf::OAPISchemas::AccountSettingsRequest]
        accountSettings: {
          class: Jamf::OAPISchemas::AccountSettingsRequest
        },

        # @!attribute recoveryLockPassword
        #   @return [String]
    ...
    end # class PostComputerPrestageV3
