...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: CloudIdPCommonRequest
    #
    ...
    # of their attributes.
    #  - Jamf::OAPISchemas::AzureConfigurationRequest
    ...
    #
    #
    class CloudIdPCommonRequest < Jamf::OAPIObject
    ...
    end # class CloudIdPCommonRequest
