...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ComputerOperatingSystemUpdate
    #
    #
    #
    ...
    #
    #
    class ComputerOperatingSystemUpdate < Jamf::OAPIObject
    ...
    end # class ComputerOperatingSystemUpdate
