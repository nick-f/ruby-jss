...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: InventoryPreloadRecordSearchResults
    #
    #
    #
    ...
    #
    #
    class InventoryPreloadRecordSearchResults < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPISchemas::InventoryPreloadRecord>]
        results: {
    ...
    end # class InventoryPreloadRecordSearchResults
