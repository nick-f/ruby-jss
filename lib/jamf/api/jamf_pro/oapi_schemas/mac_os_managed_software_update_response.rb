...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: MacOsManagedSoftwareUpdateResponse
    #
    #
    #
    ...
    #
    #
    class MacOsManagedSoftwareUpdateResponse < Jamf::OAPIObject

      

      OAPI_PROPERTIES = {

        # @!attribute processManagerUuids
        #   @return [Array<String>]
        processManagerUuids: {
          class: :string,
          multi: true
    ...
    end # class MacOsManagedSoftwareUpdateResponse
