...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: VolumePurchasingSubscriptions
    #
    #
    #
    ...
    class VolumePurchasingSubscriptions < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute results
        #   @return [Array<Jamf::OAPISchemas::VolumePurchasingSubscription>]
        results: {
          class: Jamf::OAPISchemas::VolumePurchasingSubscription,
          multi: true
        }

      } # end OAPI_PROPERTIES

    end # class VolumePurchasingSubscriptions
