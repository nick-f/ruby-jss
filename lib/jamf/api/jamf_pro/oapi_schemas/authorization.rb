...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: Authorization
    #
    #
    #
    ...
    #  - '/auth:GET' needs permissions:
    #    - Unknown
    #
    #
    class Authorization < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute account
        #   @return [Jamf::OAPISchemas::AuthAccount]
        account: {
          class: Jamf::OAPISchemas::AuthAccount
        },
