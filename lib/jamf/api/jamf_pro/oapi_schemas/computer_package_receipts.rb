...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ComputerPackageReceipts
    #
    ...
    #
    #
    class ComputerPackageReceipts < Jamf::OAPIObject

      

      OAPI_PROPERTIES = {

        # @!attribute installedByJamfPro
        #   @return [Array<String>]
        installedByJamfPro: {
          class: :string,
          multi: true
        ...
        # @!attribute installedByInstallerSwu
        #   @return [Array<String>]
    ...
    end # class ComputerPackageReceipts
