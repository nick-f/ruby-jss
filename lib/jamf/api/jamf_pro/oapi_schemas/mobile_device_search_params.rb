...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: MobileDeviceSearchParams
    #
    #
    #
    ...
    #
    #
    class MobileDeviceSearchParams < Jamf::OAPIObject
    ...
    end # class MobileDeviceSearchParams
