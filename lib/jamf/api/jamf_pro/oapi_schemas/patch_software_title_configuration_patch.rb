...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: PatchSoftwareTitleConfigurationPatch
    #
    #
    #
    ...
    #  - Jamf::OAPISchemas::PatchSoftwareTitlePackages
    ...
    #
    #
    class PatchSoftwareTitleConfigurationPatch < Jamf::OAPIObject
    ...
    end # class PatchSoftwareTitleConfigurationPatch
