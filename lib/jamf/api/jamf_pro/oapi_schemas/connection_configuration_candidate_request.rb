...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ConnectionConfigurationCandidateRequest
    #
    ...
    #
    #
    class ConnectionConfigurationCandidateRequest < Jamf::OAPIObject
    ...
    end # class ConnectionConfigurationCandidateRequest
