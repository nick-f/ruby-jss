...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: MembershipMappings
    #
    ...
    #
    #
    class MembershipMappings < Jamf::OAPIObject

      

      OAPI_PROPERTIES = {

        # @!attribute groupMembershipMapping
        #   @return [String]
