...
module Jamf
  ...
  module OAPISchemas
    ...
    #  - Jamf::OAPISchemas::PrestageScopeAssignment
    #
    ...
    class PrestageScopeResponse < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        #   @return [Array<Jamf::OAPISchemas::PrestageScopeAssignment>]
        assignments: {
          class: Jamf::OAPISchemas::PrestageScopeAssignment,
          multi: true
        },
    ...
    end # class PrestageScopeResponse
