...
module Jamf
  ...
  module OAPISchemas
    ...
    #
    #
    class EraseDeviceCommand < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute disallowProximitySetup
        #   @return [Boolean]
        ...
        # @!attribute obliterationBehavior
        #   @return [String]
        obliterationBehavior: {
          class: :string,
          enum: OBLITERATION_BEHAVIOR_OPTIONS
        },

        # The configuration settings for Return to Service.
        # @!attribute returnToService
