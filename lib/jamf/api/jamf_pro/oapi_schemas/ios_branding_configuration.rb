...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: IosBrandingConfiguration
    #
    #
    #
    ...
    # of their attributes.
    #  - Jamf::OAPISchemas::IosBrandingSearchResults
    #
    # Sub Objects:
    ...
    #
    #
    class IosBrandingConfiguration < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute headerBackgroundColorCode
        #   @return [String]
        ...
        # @!attribute brandingNameColorCode
        #   @return [String]
    ...
    end # class IosBrandingConfiguration
