...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ConnectionConfigurationResponse
    #
    ...
    #
    #
    class ConnectionConfigurationResponse < Jamf::OAPIObject
    ...
    end # class ConnectionConfigurationResponse
