...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: GsxConnection
    #
    #
    #
    ...
    #  - '/v1/gsx-connection:GET' needs permissions:
    #    - Read GSX Connection
    #    - Read Push Certificates
    #  - '/v1/gsx-connection:PUT' needs permissions:
    #    - Update GSX Connection
    #    - Update Push Certificates
    #  - '/v1/gsx-connection:PATCH' needs permissions:
    #    - Update GSX Connection
    #    - Update Push Certificates
    #
    #
    class GsxConnection < Jamf::OAPIObject
