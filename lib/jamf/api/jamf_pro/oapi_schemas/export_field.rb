...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ExportField
    #
    ...
    # of their attributes.
    #  - Jamf::OAPISchemas::ExportParameters
    #
    # Sub Objects:
    ...
    #
    #
    class ExportField < Jamf::OAPIObject
