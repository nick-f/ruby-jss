...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: EnrollmentAccessGroupV2
    #
    #
    #
    ...
    # of their attributes.
    #  - Jamf::OAPISchemas::AccessGroupsV2SearchResults
    #
    # Sub Objects:
    ...
    #
    #
    class EnrollmentAccessGroupV2 < Jamf::OAPIObject
    ...
    end # class EnrollmentAccessGroupV2
