...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: EnrollmentCustomizationPanelLdapAuth
    #
    #
    #
    ...
    #
    #
    class EnrollmentCustomizationPanelLdapAuth < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute ldapGroupAccess
        #   @return [Array<Jamf::OAPISchemas::EnrollmentCustomizationLdapGroupAccess>]
        ldapGroupAccess: {
          class: Jamf::OAPISchemas::EnrollmentCustomizationLdapGroupAccess,
          multi: true
        }

      }.merge(Jamf::OAPISchemas::EnrollmentCustomizationPanel::OAPI_PROPERTIES) # end OAPI_PROPERTIES

    end # class EnrollmentCustomizationPanelLdapAuth
