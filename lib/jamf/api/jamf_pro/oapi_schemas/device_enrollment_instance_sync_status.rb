...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: DeviceEnrollmentInstanceSyncStatus
    #
    #
    #
    ...
    #
    #
    class DeviceEnrollmentInstanceSyncStatus < Jamf::OAPIObject
    ...
    end # class DeviceEnrollmentInstanceSyncStatus
