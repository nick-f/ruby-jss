...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ProtectUpdatableSettingsRequest
    #
    #
    #
    ...
    #
    #
    class ProtectUpdatableSettingsRequest < Jamf::OAPIObject
    ...
    end # class ProtectUpdatableSettingsRequest
