...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: AzureConfigurationRequest
    #
    ...
    #  - Jamf::OAPISchemas::AzureServerConfigurationRequest
    #
    ...
    #
    #
    class AzureConfigurationRequest < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute server
        #   @return [Jamf::OAPISchemas::AzureServerConfigurationRequest]
        server: {
          class: Jamf::OAPISchemas::AzureServerConfigurationRequest,
          required: true
        }

      } # end OAPI_PROPERTIES

    end # class AzureConfigurationRequest
