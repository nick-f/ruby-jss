...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: ConnectionConfigurationUpdateRequest
    #
    ...
    #
    #
    class ConnectionConfigurationUpdateRequest < Jamf::OAPIObject
    ...
    end # class ConnectionConfigurationUpdateRequest
