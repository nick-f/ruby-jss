...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: SupervisionIdentityCertificateUpload
    #
    #
    #
    ...
    #
    #
    class SupervisionIdentityCertificateUpload < Jamf::OAPIObject
    ...
    end # class SupervisionIdentityCertificateUpload
