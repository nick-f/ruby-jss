...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: SelfServiceInteractionSettings
    #
    ...
    #
    #
    class SelfServiceInteractionSettings < Jamf::OAPIObject
    ...
    end # class SelfServiceInteractionSettings
