...
module Jamf
  ...
  module OAPISchemas
    ...
    # OAPI Object Model and Enums for: InventoryInformation
    #
    ...
    #  - '/v1/inventory-information:GET' needs permissions:
    #    - Unknown
    #
    #
    class InventoryInformation < Jamf::OAPIObject
      ...
      OAPI_PROPERTIES = {
        ...
        # @!attribute [r] unmanagedComputers
        #   @return [Integer]
        unmanagedComputers: {
          class: :integer,
          readonly: true,
    ...
    end # class InventoryInformation
